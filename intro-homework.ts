...
console.log(`The text "${text}" is ${isLong ? 'longer' : 'not longer'} than 10 characters.`);
...
console.log(`The number ${numberX} is ${isPositive ? 'positive' : 'not positive'}.`);
...
console.log(`The number ${numCheck} is ${isNonPositive ? `equal to 0` : `not equal to 0`}`);
...
console.log(`The number ${rangeNumber} is ${isInRange ? 'within' : 'outside'} the range of 10 to 100.`);
...
console.log(`The number ${specialNumber} is ${isZeroOrHundred ? 'either 0 or 100' : 'neither 0 or 100'}.`);
...
console.log(`The number ${oddCheck} is ${isOddAndLarge ? 'odd and greater than 50' : 'either not odd or not greater than 50'}.`);
...
console.log(`The word "${word}" ${startsWithA ? 'starts with A' : 'does not start with A'}.`);
